...
MapTo('honda/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('honda/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('honda/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});

MapTo('honda/components/button')(ButtonV1, {isEmpty: ButtonV1IsEmptyFn});
MapTo('honda/components/teaser')(TeaserV1, {isEmpty: TeaserV1IsEmptyFn});
MapTo('honda/components/image')(ImageV2, {isEmpty: ImageV2IsEmptyFn});
MapTo('honda/components/title')(TitleV2, {isEmpty: TitleV2IsEmptyFn});


MapTo('honda/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('honda/components/navigation')(NavigationV1);
MapTo('honda/components/languagenavigation')(LanguageNavigationV1);


MapTo('honda/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('honda/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
...
MapTo('honda/components/text')(LazyTextComponent, TextEditConfig);